        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-6xl m-4 md:m-8 lg:mx-16 text-gray-800">
                <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl shadow-indigo-900/10 overflow-hidden border border-indigo-300 grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-4 md:p-12 lg:p-16 flex flex-col justify-center">
                                ...
                                {inputFields.map(({ id, Label, type, value, required, placeholder, onChange }) => (
                                    <div key={id} className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-300 to-purple-300 rounded-xl blur opacity-0 group-hover:opacity-20 transition duration-300">
                                            </div>
