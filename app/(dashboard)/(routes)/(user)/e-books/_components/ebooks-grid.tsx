...
export const EbooksGrid = ({ ebooks }: { ebooks: EbookListItem[] }) => {
  ...
  const onCardClick = (ebookId: string) => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      const res = await fetch("/api/student/leads", {
        ...
        body: JSON.stringify({ ...values, eBookId: selectedEbookId }),
      });
      ...
      window.open(`/e-books/${selectedEbookId}/read`, "_blank", "noopener,noreferrer");
    } catch (e: unknown) {
      console.error(e);
